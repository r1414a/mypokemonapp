...
export default function PokemonSearchBar({searchTerm,setSearchTerm,handleSearch,pokemonList,setFilteredPokemon}) {
  const searchBarRef = useRef(null);
    ...
    return (
        <section className="flex flex-col justify-center items-center my-6 md:my-4">
        ...
        <div className="relative flex items-center w-full max-w-md px-5 md:px-0">
            <PokemonFilter
            ...
            <input
                ...
                className="w-full p-3 rounded-lg bg-gray-800 text-yellow-400 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400 shadow-xl/20 shadow-yellow-400/50"
            />
